...
class BlocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post blocks_url, params: { block: { block_id: @block.block_id, user_id: @block.user_id } }
    end
  ...
  test "should update block" do
    patch block_url(@block), params: { block: { block_id: @block.block_id, user_id: @block.user_id } }

...
class RoomMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create room_member" do
    assert_difference('RoomMember.count') do
      post room_members_url, params: { room_member: { room_id: @room_member.room_id, user_id: @room_member.user_id } }
    end

    assert_redirected_to room_member_url(RoomMember.last)
  end
  ...
  test "should update room_member" do
    patch room_member_url(@room_member), params: { room_member: { room_id: @room_member.room_id, user_id: @room_member.user_id } }
